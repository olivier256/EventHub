 ...
 * {@code java.lang.String}. It inherits from the {@code Message} interface and
 * adds a text message body.
 *
 * <P>
 ...
 *
 * <P>
 * When a client receives a {@code TextMessage}, it is in read-only mode. If a
 * client attempts to write to the message at this point, a
 * {@code MessageNotWriteableException} is thrown. If {@code clearBody} is
...
public interface TextMessage extends Message {
	 ...
	 *                                         text due to some internal error.
	 ...
	 * 
	 * @exception JMSException if the JMS provider fails to get the text due to some
	 *                         internal error.
	 */
