...
/**
 * A {@code CompletionListener} is implemented by the application and may be
 ...
 * reason, and an exception cannot be thrown by the {@code send} method, then
 * the JMS provider calls the {@code onException(Exception)} method of the
 * specified completion listener.
 * 
...
public interface CompletionListener {
	 ...
	 * send the specified message. If an exception occurs it is undefined whether or
